package com.intellistart.interviewplanning.controllers.nats

import com.google.protobuf.GeneratedMessageV3
import com.google.protobuf.Parser
import com.intellistart.interviewplanning.NatsSubject
import com.intellistart.interviewplanning.commonmodels.slot.Slot
...
import com.intellistart.interviewplanning.slot.application.service.SlotOperations
...
class UpdateNatsControllerIT {
    ...
    @Autowired
    lateinit var slotService: SlotOperations
    ...
    fun `should return success response for update slot`(
        ...
        slotService.create(
            com.intellistart.interviewplanning.slot.domain.model.Slot(
                id = idTest,
                period = Period(
    ...
    fun `should return failure response for update slot`(
        ...
        val expectedSlotResponse = UpdateSlotResponse.newBuilder().apply {
            failureBuilder.apply {
                failureBuilder.message = "Time boundaries of period are invalid."
            }
        }.build()
